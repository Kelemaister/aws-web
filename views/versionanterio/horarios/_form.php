...
<div class="horarios-form">
    ...
    'INFO_SNAPS' => 'INFO_SNAPS', 'INFO_VOLUMENES' => 'INFO_VOLUMENES', 'COPY_REG_AMIS' => 'COPY_REG_AMIS', 'COPY_REG_SNAPS' => 'COPY_REG_SNAPS', 'INFO_INST_RESERV' => 'INFO_INST_RESERV', 'DEPURA_AMIS' => 'DEPURA_AMIS', 'DEPURA_SNAP' => 'DEPURA_SNAP' ]); ?>
 ...
 [
    ...
    <?php
        $intance = InstanciasActivasVw::find()->all();
