...
?>
<h2 align="center" style="margin-top: -20px;">Instancias programadas</h2>
<div style="width: 114%; display: inline-flex; margin-left: -7%;">
    <div style="width: 40%;">
        <?php
            $f = ActiveForm::begin([
                "method" => "get",
                "action" => Url::toRoute("horario/instanciasprogramadas"),
    ...
    <div style="width: 20%; text-align: center;">
        ...
        ?>
        <div>
            <?=Html::submitButton("Listar Instancias Programadas", ["class" => "btn btn-primary", 'style' => 'margin-top: 8%;']) ?>
        </div>
        <?php
            $listar->end();
        ?>
       ...
       <a class="popup-cerrar" href="#">X</a>
        ...
        $array = [];//Array vacio para poder usar dropDownList, --Los items del dropDownList cambiaran en ajax/myjs.js--
            $editar = ActiveForm::begin([
                "method" => "post",
                "action" => Url::toRoute("horario/editarinstanciaprogramada"),
                "enableClientValidation" => true,
            ]);
        ?>
        ...
        <?= $editar->field($actualizar, 'horaApagar')->widget(TimePicker::classname(), ['pluginOptions' => [
                                        ...
                                        'showMeridian' => false,
                                        'minuteStep' => 1,
                                        'secondStep' => 5,], 'options' => ['id' => 'horaApagar','readonly' => true,]]); ?>
