...
?>
<h2 align="center" style="margin-top: -20px;">Snapshots <?= $region?></h2>
<div style="width: 114%; display: inline-flex; margin-left: -7%;">
    <div style="width: 40%;">
        <?php 
            $f = ActiveForm::begin([
                "method" => "get",
                "action" => Url::toRoute("snapshots/virginia"),
                "enableClientValidation" => true,]);
        ?>
        <div style="width: 76%; display: inline-flex;">
    ...
    <div style="width: 40%;">
        ...
        <div style="width: 76%; display: inline-flex; float: right;">
            <?= $fecha->field($fech, 'date_1')->widget(DatePicker::classname(), [
                'pluginOptions' => [
                'autoclose'=>true,
                'format' => 'yyyy-mm-dd'],
