...
class BitacoraController extends Controller
{
    ...
    {    
        $searchModel = new SearchBitacora();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Bitacora",
                    'content'=>'<span class="text-success">Create Bitacora success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
